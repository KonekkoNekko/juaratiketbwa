    ...
    <div class="relative flex flex-col w-full min-h-screen max-w-[640px] mx-auto bg-white">
        ...
        <main id="details" class="flex flex-col gap-5 px-4 pb-[116px]">
            <section id="Get-to-Know" class="flex flex-col gap-[6px]">
                ...
                <p class="text-sm leading-[28px]">Under the later kings of the Persian Empire, the Cappadocians were
                    divided into two satrapies, or governments, with one comprising the central and inland portion, to
                    which the name of Cappadocia continued to be applied by Greek Angga Ris.</p>
            </section>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex items-center rounded-3xl p-[14px_16px] gap-4 bg-[#F8F8F9]">
                        ...
                        <div class="text-left">
                            ...
                            <p class="font-bold text-lg leading-[27px]">09:00</p>
                        </div>
                    </div>
                    <div class="flex items-center rounded-3xl p-[14px_16px] gap-4 bg-[#F8F8F9]">
                        ...
                        <div class="text-left">
                            ...
                            <p class="font-bold text-lg leading-[27px]">21:00</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="w-full h-[200px] overflow-hidden">
                    <div id="embedded-map-display" class="w-full h-full">
                        <iframe class="w-full h-full" frameborder="0"
                            src="https://www.google.com/maps/embed/v1/place?q={{ $ticket->address }}&key={{ config('services.google_maps.api_key') }}"></iframe>
                    </div>
                </div>

    ...
    <div class="relative flex flex-col w-full min-h-screen max-w-[640px] mx-auto bg-white">
        ...
        <main id="details" class="flex flex-col gap-5 px-4 pb-[116px]">
            <section id="Get-to-Know" class="flex flex-col gap-[6px]">
                ...
                <p class="text-sm leading-[28px]">Under the later kings of the Persian Empire, the Cappadocians were divided into two satrapies, or governments, with one comprising the central and inland portion, to which the name of Cappadocia continued to be applied by Greek Angga Ris.</p>
            </section>
